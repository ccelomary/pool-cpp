...
/*   Updated: 2021/06/23 19:36:25 by mel-omar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(const std::string & name, bool is_signed, int grade2SignIt, int grade2ExecuteIt): name(name), grade_required_to_sign_it(Form::check_return_grade(grade2SignIt)),
...
void    Form::beSigned(const Bureaucrat &bc) throw (Form::GradeTooHighException)
{
